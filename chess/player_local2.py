...
pygame.init()
pygame.font.init()
os.environ['SDL_VIDEO_WINDOW_POS'] = "%d,%d" % (pygame.display.Info().current_w - 1020, pygame.display.Info().current_h - 750)
...
# 加载相关素材
playerBackgroud = pygame.image.load("C:/Users/chiya/PycharmProjects/qjh/chess/material/1.jpg")
mainBackground = pygame.image.load("C:/Users/chiya/PycharmProjects/qjh/chess/material/mainScene.jpg")
startButton = pygame.image.load("C:/Users/chiya/PycharmProjects/qjh/chess/material/startGame.png")
blackChess = pygame.image.load("C:/Users/chiya/PycharmProjects/qjh/chess/material/blackChess.png")
whiteChess = pygame.image.load("C:/Users/chiya/PycharmProjects/qjh/chess/material/whiteChess.png")
redChess = pygame.image.load("C:/Users/chiya/PycharmProjects/qjh/chess/material/redChess.png")
redChess2 = pygame.image.load("C:/Users/chiya/PycharmProjects/qjh/chess/material/redChess2.png")
# 当前场景
...
# 此处填写服务器的公网ip
#client.connect(('10.151.6.122', 6688))
